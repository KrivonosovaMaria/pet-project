...
@Component({
	selector: 'app-stats-race-ticket',
	imports: [
		ChartComponent
	],
	templateUrl: './stats-race-ticket.component.html',
	standalone: true,
})

export class StatsRaceTicketComponent implements OnInit {
